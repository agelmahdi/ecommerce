        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                @if(!empty(setting()->logo))
                    <img src="{{\Illuminate\Support\Facades\Storage::url(setting()->logo)}} " style="width: 50px; height: 50px ">
                @endif
            </div>
            <div class="form-group">
                ...
                @if(!empty(setting()->icon))
                    <img src="{{\Illuminate\Support\Facades\Storage::url(setting()->icon)}} " style="width: 50px; height: 50px ">
                @endif
            </div>
            <div class="form-group">
